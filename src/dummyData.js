export const DummyData = [
  ...
  },
  {
    ...
    description: 'Because of its proximity to Royal Portrush, Castlerock, like Portstewart, never seems to get the credit it deserves. But believe me, it merits your attention. This is a terrific links, one that is nearly always firm and bouncy in summer, which only adds to the questions asked of your game. This isn’t the longest course, but driving is important. Accurate tee shots will set you up nicely for the approaches into what are tricky greens. I have never had anything but fun playing and practising at Castlerock, which is as good a recommendation as I can give any course.',
    lat: 55.1658155,
    long: -6.7868815,
    golfer: 'Leona',
  ...
  {
    name: 'Black Bush Golf Club',
    location: 'Co. Meath',
    description: 'Yet another beautiful parkland course in the Co Meath area, not far from Dublin, Black Bush has three loops of nine holes that require a variety of shot making. I have always found it to be very enjoyable, the smallish greens and their surrounds are a good test of approach play and chipping. I also like that almost every hole has a number of tees. So you can make each hole as difficult or as straightforward as you wish. Golf doesn’t have to be tough to be fun. Which is perhaps why Black Bush’s Open Week is one of the most popular in Ireland. They are doing something right.',
    lat: 53.5275657,
    long: -6.5295065,
    golfer: 'Leona',
    image: 'blackbush.jpg'
  ...
  {
    name: 'County Sligo Golf Club at Rosses Point',
    location: 'Co. Sligo',
  ...
  {
    name: 'Royal Belfast Golf Club',
    location: 'Co. Down',
    description: 'This is one course – the oldest club on the island of Ireland – that can justifiably be called a “hidden gem”. It boasts a number of strong holes. Four of the five par-threes measure more than 175 yards in length and two of the last three are testing par-fives. I’m not sure why this lovely layout, designed by Harry Colt, does not get more recognition. Maybe the club’s inclination towards privacy has something to do with that. Whatever, it deserves to be hailed as one of Northern Ireland’s premier inland courses, although it runs along the shore of Belfast Lough.',
    lat: 54.6599406,
    long: -5.7875065,
    golfer: 'Padraig',
  ...
  },
  {
    ...
    location: 'Co. Wicklow',
    description: 'Just south of Dublin, this is a great, fun links, built and owned by one of Irish golf’s great characters, Pat Ruddy. On any given day, he might change the routing of the course and the numbers of the holes, you just never know. No matter what though, the European Club is an exciting place to play, with some of the most spectacular holes in the country. One bit of advice: it can be a beast, even for professionals, if you play off the wrong tees. So be realistic about how far back you go.',
    lat: 52.8596907,
    long: -6.0712565,
    golfer: 'Padraig',
  ...
  },
  {
    name: 'The K Club',
    location: 'Co. Kildare',
    description: 'All you need to know about the Palmer Course at the K Club is that it has hosted the Irish Open, the European Open and the 2006 Ryder Cup. There’s a five-star hotel too. But the K Club is the place I go to when I am preparing to play golf on either the PGA Tour or the European Tour. It is more like a typical tournament venue than any other course in Ireland. There are so many exciting “risk-reward” holes that challenge your nerve and your swing. It is quite simply a great test of golf.',
    lat: 53.3065657,
    long: -6.6275065,
    golfer: 'Padraig',
    image: 'k_club.jpg'
  },
  {
    ...
    location: 'Co. Wicklow',
    description: 'Only about 30 years old, but already a four-time host of the Irish Open, this is another of my favourite places to play. And, although relatively young in golf terms, the site has so much history. The course has a number of spectacular holes, none more so than the short 17th. It is reminiscent of the penultimate hole at Sawgrass in Florida in that it features what is virtually an island green. Elsewhere, more water and trees present a challenge that is both testing and memorable. In my experience, the atmosphere in the clubhouse is just as good too.',
    lat: 53.0955657,
    long: -6.0807565,
    golfer: 'Padraig',
  ...
  },
  {
    ...
    location: 'Co. Kerry',
    description: 'Situated on the shores of Lough Leane, Killarney is, like so many others in Ireland, a town absolutely consumed by the game of golf. As such, the courses are very much part of a thriving community boasting any number of fine pubs and restaurants. There is a lot of tourist activity and a great atmosphere about the place. Killeen, the flagship parkland course, is gorgeous, both in golfing terms and scenically. If you can’t have fun and enjoy playing golf at Killarney, I’m not sure I can really help you. It is a great spot to hang out in.',
    lat: 52.0604408,
    long: -9.5655065,
    golfer: 'Padraig',
    image: 'killarney.jpg'
